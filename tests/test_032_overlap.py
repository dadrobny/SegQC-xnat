...
import segfacet.heuristics.overlap  # noqa: F401 — triggers OverlapRule registration
...
def test_ac1_overlap_rule_is_rule_subclass():
    """AC1: The registered OverlapRule is a subclass of segfacet.heuristics.Rule."""
