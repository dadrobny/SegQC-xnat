...
* A small module-level registry (mirroring ``segqc.heuristics.rule``'s
...
class Expectation:
    ...
    expected_verdict:
        ...
        real :class:`~segqc.verdict.Severity` labels).
    detail:
...
# --------------------------------------------------------------------------- #
# Registry (mirrors segqc.heuristics.rule's _RULES idiom)
# --------------------------------------------------------------------------- #
