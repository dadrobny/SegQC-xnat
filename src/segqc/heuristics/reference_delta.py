...
``segqc.reference.reference_delta_to_dict`` shape). It fires a ``Finding``
...
already-computed numbers. It imports nothing from ``segqc.reference``, loads
...
``default_config.yaml``, ``segqc.report``, or ``segqc.aggregate`` — wiring
