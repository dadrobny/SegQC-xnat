...
edit the CLI (item 006). It raises :class:`segfacet.io.FacetInputError` on a
...
class LabelConvention:
    ...
    :class:`segfacet.io.FacetInputError`.
...
def summarise_inventory(
    ...
    inventory:
        ...
        :attr:`segfacet.io.Case.label_inventory` (whose keys/counts are already pure
