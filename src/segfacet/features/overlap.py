...
class OverlapPair:
    ...
    name_a:
        ...
        :class:`~segfacet.labels.LabelConvention`, or
        :data:`~segfacet.labels.UNKNOWN` for unmapped integers.
    name_b:
...
def detect_overlaps(
    ...
    **deterministic**: identical inputs always produce identical outputs.
    ...
    convention:
        Optional :class:`~segfacet.labels.LabelConvention` used to resolve
